...
<body>
    <div class="ACon">
        <div class="Profile">
            <?php
                if (empty($details->user_details->image)){
                    $avatar = "IMG_20190224_102545.jpg";
                }
                else{
                    $avatar = "OIP.jpg";
                }
            ?>
            <div class="Img" style='background:url("../images/<?= $avatar; ?>"'>
                <div class="overlay"
                    <span>
                        <img/>
                    </span>
            ...
            <h4><a class="username" href="">{{$details->name}}</a></h4>
               
                <h5 class="buttons b"><a class="username" href="/user/profile/edit">Edit Profile</a></h5>
                <div class="Social">
        ...
        $(document).ready(function(){
            ...
            $('.Img').on('click', function() {
                ...
                if($Menu.hasClass('Img')){
                    ...
                    $('.click').css({'background': 'url("../images/<?= $avatar; ?>"','background-size':'contain'});
